...
for (let i = 0; i < symbolsNames.length; i++) {

  var samplePurchaseDateRange = faker.date.between('2015-03-03', '2019-02-02');
  var sampleQuantity = faker.random.number(100);
  ...
  const insertSamplePurchase = function() {
